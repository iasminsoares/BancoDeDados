A subconsulta é como se eu pegasse uma consulta e usasse ela como se fosse uma tabela separada, uma consulta separada. 
Então, eu posso usar a subconsulta tanto dentro de um FROM como, por exemplo, dentro de um critério de busca.
