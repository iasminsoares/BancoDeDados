...
SELECT * FROM [TABELA DE PRODUTOS] WHERE [NOME DO PRODUTO] LIKE '%Litros%' -- traz todo mundo q contem

SELECT * FROM [TABELA DE PRODUTOS] WHERE [NOME DO PRODUTO] LIKE 'Litros%' -- traz todo mundo q inicia

SELECT * FROM [TABELA DE CLIENTES] WHERE [NOME] LIKE '%Mattos' -- traz todo mundo q tem o nome no final
